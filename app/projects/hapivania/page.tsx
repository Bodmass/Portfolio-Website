  ...
  return (
    <div className="w-full flex justify-center">
      <div className="w-full xl:w-2/3 m-2 wrap-break-word whitespace-normal text-left">
        ...
        <p>
          The game created using the engine is a Metroidvania-style platformer which allows the player to earn upgrades
        ...
        <p>HAPIvania also comes with a Level Editor created in WPF. The Editor exports and imports level using XML.</p>
